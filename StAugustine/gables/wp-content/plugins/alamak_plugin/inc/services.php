...
function wpt_services_posttype() {
	register_post_type( 'services',
		array(
			...
			'menu_position' => 5,
			'register_meta_box_cb' => 'services_metabox_add',
...
add_action('admin_enqueue_scripts', 'services_metabox');

//add Post Details metabox
add_action( 'add_meta_boxes', 'services_metabox_add' );
function services_metabox_add()
{
    add_meta_box( 'services-details', 'Post Details', 'metabox_services_form', 'services', 'normal', 'high' );
}

function metabox_services_form( $post )
{
...
<p id="tab-title-name" >
    ...
    <small>Enter Title for "Services" tab here</small>
</p>
<p id="black-text" >
