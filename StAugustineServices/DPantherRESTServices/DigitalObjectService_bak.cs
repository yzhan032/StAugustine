    ...
    public class DigitalObjectService : IDPantherServices
    {
        ...
        private string addListwizFacet(ref List<DigitalObjectBrif> li, DataRow dr, string hostName)
        {
            ...
            try
            {
                ...
                digiBrif.htmlContent = GeneralFunction.getSobekContentHTMLfromURL("http://" + hostName + dirSobekContentPath + digiBrif.BibID + "/" + digiBrif.VID + "/citation", hostName);// GeneralFunction.getSobekContentHTML(strPath + "sobek_files\\" + digiBrif.BibID + "_" + digiBrif.VID + ".html");
